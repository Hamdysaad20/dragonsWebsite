...
function Userinfo() {
  return (
    <div className='w-full relative rounded-t-2xl  bg-gray-800/40 backdrop-blur-lg border-8 border-b-0 border-white'>
          ...
          <div className='rounded-3xl relative select-none  md:h-64 h-32 w-32 md:w-64'>
            <div className='rounded-3xl  relative bg-gray-700/40  backdrop-blur-lg md:h-60 h-28 w-28 md:w-60'>
              <div className='w-full  hover:scale-105 duration-1000 flex overflow-hidden rounded-3xl  h-full'>
                <Image  
                  src='/images/1.jpeg'
                  className='w-full rounded-3xl h-full select-none'
                  layout='fill'
                  alt='Core Team'
                  priority
                  placeholder="blur"
                  blurDataURL='/images/1.jpeg'
