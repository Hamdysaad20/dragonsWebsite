...
function WhatWeDo(props) {
    return (
        <div style={{fontFamily: "Poppins-Bold", width: "400"}}
            ...
            <div
                className='sm:ml-7 m-auto  align-center justify-center content_bgSec2 text-center sm:text-left max-w-3xl mx-auto pt-16 sm:pt-32  lg:pt-24'>
                <h1 className='text-slate-200 tracking-tight select-none  font-extrabold text-4xl sm:text-4xl lg:text-5xl tracking-tighttext-center lg:text-left '>
                    {props.MainText}
                    <span
                        className=' text-red-500  font-extrabold  text-5xl sm:text-5xl lg:text-6xl tracking-tighttext-center sm:text-left '>
            .
          </span>
                </h1>
                <p
                    ...
                    <Link href={"/Hire"} className="hover:underline underline-offset-1 select-none" passHref>terms and
                        conditions </Link>
