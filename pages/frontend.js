    ...
    <div className='pt-20 text-center  relative flex justify-center mx-auto flex-col max-w-[1400px]'>
      ...
      <div className='mt-12 text-xl max-w-5xl justify-center flex mx-auto leading-loose mb-20 text-gray-300'>
        ...
        <h1 className={"mx-1 px-1"}>
          دورFront end في عالم تطوير المواقع بعد ما بياخد ديزاين الموقع بيبدأ
          ...
          وتدخل فيه -- وابسط مثال يفهمك كلامنا شايف الموقع اللى انت فيه حاليا
          وبتقرأ الكلام ده منه وكمان ثوانى وهتقدم فى الفورم اللى موجوده عليه دى
          بردوا اهو كل الدزاين والاشكال والالوان دى كلها وحجم الخط ومكان كلى
          حاجه موجوده هو المسئول عنها و انها تكون بالشكل ده ف باختصار اى حاجه
          انت شايفها فى الموقع اللى عاملها الشخص المسئول عن ال front
        </h1>
      </div>
    </div>
  );
