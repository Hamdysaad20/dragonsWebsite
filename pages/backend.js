    ...
    <div className='pt-20 text-center  relative flex justify-center mx-auto flex-col max-w-[1400px]'>
      ...
      <div className='mt-12 text-xl max-w-5xl justify-center flex mx-auto leading-loose mb-20 text-gray-300'>
        ...
        <h1 className={"mx-1 px-1"}>
          ...
          لا يمكنك رؤيتها. - - مثال بردوا عشان كلامنا يكون مفهوم اكتر بردوا
          الموقع اللى انت فيه حاليا وبتقرأ الكلام منه دلوقتى مطور ال Back هو
          المسئول عن تخزين البيانات ( بيانات كل فرد هيقدم فى الفورم ) وكمان
          مسئول عن تأمين البيانات دى ... وفى بعض المواقع اللى متواجد فيها( دفع
          ...
          بتاعك.. ف اللى نلاحظه ان كل ما الموقع بيكون كبير ومتطلباته كتيره و
          معقده دور مطور ال Back بيكون كبير ويكاد يكون معقد
        </h1>
      </div>
    </div>
  );
