    ...
    <div className='pt-20 text-center  relative flex justify-center mx-auto flex-col max-w-[1400px]'>
      ...
      <div className='mt-12 text-xl max-w-5xl justify-center flex mx-auto leading-loose mb-20 text-gray-300'>
        ...
        <h1 className={"mx-1 px-1"}>
          ...
          ديما الصورة الي بيخدوها غير✨. ● فيعتبروا من أهم التيمز الي موجوده في
          أي Community ، لانها بتبين للناس العظمة المخفية وراء كل التعب والشغل
          الي بيبذله افراد ال Community وبيظهر او بيكون مخفى في الكواليس. ●
          ...
          يقراء البوست وازاى تدير صفحات السوشيل بشكل كويس ● هتتعلم ازاي بقا تعدل
          علي الصور بتاعتك لان %70من جمال الصورة من جمال تعديلك عليها وأكيد مش
          هننسي الفيديوهات علي برامج مختلفة. ** ده غير انك كمان هتتعلم فن
          التصميم اللى ضرورى وبيخدم الميديا بشكل كبير ** ● التصميم باختصار هو :
          .... الي بيرسم شكل أي كيان في عيون الناس بداية من الشعار مرورا بكل
          التفاصيل الي بتترسخ في هيكلة الكيان. ● عشان تبدأ أي مجال مش ضروري تكون
          ...
          هتستعملها. ● التصميم ليه مبادئ منها: Unity, Balance, Dominance,
          Hierarchy. ● أكيد محتاج برامج تشتغل عليها أفضلهم: Adobe Photoshop,
          Adobe Illustrator.
        </h1>
      </div>
    </div>
