    ...
    <div className='pt-20 text-center  relative flex justify-center mx-auto flex-col max-w-[1400px]'>
      ...
      <div className='mt-12 text-xl max-w-5xl justify-center text-right flex mx-auto leading-loose mb-20 text-gray-300'>
        ...
        <h1 className={"mx-1 px-1"}>
          ...
          هننسي الفيديوهات علي برامج مختلفة. ده غير انك كمان هتتعلم فن التصميم
          اللى ضرورى وبيخدم الميديا بشكل كبير
            التصميم باختصار هو : .... الي
          بيرسم شكل أي كيان في عيون الناس بداية من الشعار مرورا بكل التفاصيل الي
          بتترسخ في هيكلة الكيان.  
          عشان تبدأ أي مجال مش ضروري تكون موهوب لان أي
          مهارة تقدر تكتسبها بالممارسة زي التصميم كدا؛ لكن لازم يكون عندك صبر
          وشغف بكل ما هو مرئي وانك تعرف الاساسيات والادوات الي هتستعملها 
          .
        </h1>
      </div>
    </div>
